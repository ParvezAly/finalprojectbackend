...
ActiveRecord::Schema.define(version: 2020_07_16_155107) do

  # These are extensions that must be enabled in order to support this database
  enable_extension "plpgsql"

  create_table "attraction_areas", force: :cascade do |t|
    t.string "title"
  ...
  create_table "booking_masters", force: :cascade do |t|
